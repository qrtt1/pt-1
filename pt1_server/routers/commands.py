...
from pt1_server.services.command_manager import CommandManager, CommandInfo, ResultType, FileInfo
...
def terminate_client(client_id: str, cmd_manager: CommandManager = Depends(get_command_manager), token: str = Depends(verify_token)):
    ...
    from pt1_server.routers.client_registry import client_registry, mark_client_terminated
